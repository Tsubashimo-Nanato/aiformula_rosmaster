...
- The two robots are mechanically different. ROSMASTER is a Yahboom X3-style mecanum chassis driven through `Rosmaster_Lib` and `/dev/myserial`; Sophia is a differential two-drive-wheel AI Formula platform driven by CAN.

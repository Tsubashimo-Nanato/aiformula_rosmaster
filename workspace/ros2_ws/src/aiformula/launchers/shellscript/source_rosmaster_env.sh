...
YAHBOOM_LIBRARY_WS="${YAHBOOM_LIBRARY_WS:-/home/jetson/yahboomcar_ros2_ws/software/library_ws}"
...
if [[ -f "${YAHBOOM_LIBRARY_WS}/install/setup.bash" ]]; then
  source "${YAHBOOM_LIBRARY_WS}/install/setup.bash"
fi
